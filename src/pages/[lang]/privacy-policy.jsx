  ...
  return (
    <div className="policy-container">
      ...
      <p>
        ...
        <a href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies"</a>. Information regarding cookies from
        this Cookies Policy are from <a href="https://www.generateprivacypolicy.com/">the Privacy Policy Generator</a>.
      </p>
      <p>
      ...
      <p>
        You can prevent the setting of cookies in this site by adjusting the settings on your browser (see your browser Help
        for how to do this) or selecting "Decline" (or "Älä hyväksy") when prompted. Be aware that disabling cookies will
        affect the functionality of this and many other websites that you visit. Disabling cookies will usually result in
        also disabling certain functionality and features of the this site. Therefore it is recommended that you do not
        disable cookies. This Cookies Policy was created with the help of the{" "}
